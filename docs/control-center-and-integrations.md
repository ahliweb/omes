...
- AWCMS-side screen/API/database consumption of the AI privacy posture and egress-approval contracts (§2.10 of [docs/control-center-contracts.md](control-center-contracts.md)) — not implemented yet; no OMES issue owns that AWCMS-side work.
