...
- `stable` (default): verified immutable release tag (`v0.4.0`).
...
$ curl -fsSL https://raw.githubusercontent.com/ahliweb/omes/v0.4.0/install/bootstrap.sh | bash -s -- --channel edge
```
